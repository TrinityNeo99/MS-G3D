...
class Model(nn.Module):
    def __init__(self,
        ...
        self.sgcn2 = nn.Sequential(
            ...
            MS_TCN(c2, c2),
            # MoE_Trans(c1, c2, temporal_merge=True),
            # MoE_Trans(c2, c2),
            MoE_Trans(c2, c2, num_frames=num_frame // 2),
        )
        # self.sgcn2[-1].act = nn.Identity()
        self.tcn2 = MS_TCN(c2, c2)
        # self.tcn2 = MoE_Trans(c2, c2, num_frames=num_frame // 2)
        ...
        self.sgcn3 = nn.Sequential(
            ...
            MS_TCN(c3, c3),
            # MoE_Trans(c2, c3, temporal_merge=True, num_frames=num_frame // 2),
            # MoE_Trans(c3, c3),
            MoE_Trans(c3, c3, num_frames=num_frame // 4),
        )
        # self.sgcn3[-1].act = nn.Identity()
        self.tcn3 = MS_TCN(c3, c3)
        # self.tcn3 = MoE_Trans(c3, c3, num_frames=num_frame // 4)
...
class Model(nn.Module):
    def __init__(self,
        ...
        self.sgcn1[-1].act = nn.Identity()
        # self.tcn1 = MS_TCN(c1, c1)
        self.tcn1 = MoE_Trans(c1, c1, dropout=dropout)
        ...
        self.sgcn4 = nn.Sequential(
            ...
            # MoE_Trans(c3, c3),
            MoE_Trans(c4, c4, num_frames=num_frame // 8),
        )
